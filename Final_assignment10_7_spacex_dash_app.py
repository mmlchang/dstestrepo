...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig.update_layout(title='success-pie-chart')
        return fig
    else:
        filtered_df = spacex_df[spacex_df['Launch Site']==entered_site]
        data = filtered_df['class'].value_counts().rename_axis('class').reset_index(name='counts')
        # return the outcomes piechart for a selected site
        fig = px.pie(data, values='counts', 
        names= 'class', 
        title= ('total-success-for'+ f'{entered_site}'))
        fig.update_layout(title='success-pie-chart')
        return fig
...
def get_scatter_plot(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        fig.update_layout(title='success-payload-scatter-chart')
        return fig
    else:
